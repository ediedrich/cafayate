...
\vspace{0.9em}
% Licencia: CC BY-NC-SA 4.0, la misma de El Balcón. Confirmar con la autora.
...
\vspace{0.9em}
% ISBN 978-...\par   % <- cuando se tramite
...
% --- Datos de impresión: completar cuando se contrate la imprenta ---
% Se terminó de imprimir en [MES] de [AÑO] en [IMPRENTA], [CIUDAD], sobre
% papel [PAPEL INTERIOR] de [GRAMAJE] g/m², con tapas en [CARTULINA].
% Tirada: [N] ejemplares.
