...
% Sello, ISBN, licencia, imprenta, papel, tapas y tirada están en
% datos-editorial.tex, que lee también la cubierta. Detalle de cada dato
% en PENDIENTES-editorial.md.
\input{datos-editorial}
...
pimienta. También se lo llama aguaribay, y los antiguos lo llamaban
«sanalotodo». La tradición destaca sobre todo
...
estomacal, sedante y carminativo. Es el yuyo al que se recurre para
levantar el ánimo, aliviar jaquecas y fiebres, dormir mejor y calmar la
ansiedad. Tiene además fama de fortalecer el corazón, y en el valle se
lo toma para las palpitaciones. En
...
bronquitis, la laringitis y la faringitis se la toma por su fama de
antibacteriana, descongestionante y expectorante. El jarabe se prepara machacando las
...
úlceras de estómago. A la infusión se la tiene por hemostática, capaz de
detener el sangrado de cortaduras y de fístulas, y una hoja bien lavada
se apoya sobre las heridas con el mismo fin, para ayudar a cicatrizar y,
según dicen, prevenir infecciones. Una gotita del jugo de hojas
...
\vspace{0.6em}
\noindent Sitios consultados en septiembre de 2026:
