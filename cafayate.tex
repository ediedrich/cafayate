...
% ------------------ Datos que completa la editorial ------------------
% Editorial Juana Manuela completa estos datos y gestiona el ISBN.
% Mientras un dato esté vacío, el libro lo imprime en un recuadro
% amarillo y la compilación avisa cuántos faltan. Detalle de cada uno
% en PENDIENTES-editorial.md.
\def\datoSello{}          % pie editorial, p. ej.: Editorial Juana Manuela, Salta
\def\datoISBN{}           % p. ej.: 978-987-XXXX-XX-X
\def\datoFechaImpresion{} % p. ej.: noviembre de 2026
\def\datoImprenta{}       % p. ej.: Imprenta X, Salta
\def\datoPapel{}          % p. ej.: obra de 90 g/m²
\def\datoTapas{}          % p. ej.: cartulina ilustración de 300 g/m², laminado mate
\def\datoTirada{}         % p. ej.: 500
% La autora confirmó la licencia CC BY-NC-SA 4.0 de la p. iv: pasar a
% \licenciaconfirmadatrue (y, si eligió otra, cambiar el texto).
...
\usepackage{placeins}   % \FloatBarrier: las láminas del capítulo, antes del filete
...
% ------------------------- Color de imprenta --------------------------
% Con imprenta=true las láminas salen de img-cmyk/ (convertidas por
% cmyk.py) y el PDF declara su perfil de salida (OutputIntent). Si
% todavía no se corrió cmyk.py, usa las láminas RGB de img/ y avisa.
\ifimprenta
  \IfFileExists{perfil-salida.tex}{%
    ...
    \PackageWarningNoLine{cafayate}{Falta perfil-salida.tex: correr
      "py cmyk.py" antes de compilar para imprenta}%
  }
\else
  \newcommand{\carpetaimg}{img}
\fi

% Sin viudas ni huérfanas: el último renglón de un párrafo nunca queda
% solo arriba de una página (pasaba al pegar las cajas a su texto), y el
% primero nunca queda solo al pie.
\widowpenalty=10000
\clubpenalty=10000
\displaywidowpenalty=10000
% Con viudas y huérfanas prohibidas, a veces la página termina un renglón
% antes: mejor un pie de página desparejo que estirar el espacio entre
% fichas.
\raggedbottom
\urlstyle{same}
...
% \dato\datoX{texto}: imprime \datoX, o el texto en recuadro amarillo si
% \datoX está vacío, y lo cuenta como faltante.
\newcounter{faltantes}
\newcommand{\faltante}[1]{\stepcounter{faltantes}\pendiente{#1}}
\newcommand{\dato}[2]{\ifx#1\empty\faltante{#2}\else#1\fi}
\AtEndDocument{\ifnum\value{faltantes}>0
  \PackageWarningNoLine{cafayate}{Faltan \the\value{faltantes} datos
    editoriales (recuadros amarillos). Ver PENDIENTES-editorial.md}\fi}
...
\AddToShipoutPictureBG*{%
  \put(0,0){\includegraphics[width=\paperwidth,height=\paperheight]{\carpetaimg/01-cubierta.jpg}}}
...
\null\vfill
\noindent{\footnotesize\setlength{\parindent}{0pt}\raggedright
\textsf{\textbf{Yuyos de la Quebrada de Cafayate}}\par
\vspace{0.5em}
Edición ilustrada, \the\year.\par
\dato\datoSello{Pie editorial: lo define la editorial}\par
\vspace{0.9em}
\copyright{} María Eugenia Orellana, \the\year.\par
\vspace{0.9em}
...
\vspace{0.9em}
% Licencia: CC BY-NC-SA 4.0, la misma de El Balcón. Se confirma con
% \licenciaconfirmadatrue en el preámbulo.
Esta obra se publica bajo una licencia Creative Commons
Atribución-NoComercial-CompartirIgual 4.0 Internacional
(CC~BY-NC-SA~4.0): se permite y se agradece su reproducción total o
parcial con fines educativos y comunitarios, siempre que se cite la
fuente y que las obras derivadas se compartan con la misma licencia.
Texto de la licencia:
\url{https://creativecommons.org/licenses/by-nc-sa/4.0/deed.es}. El
monte, como el conocimiento, se cuida compartiéndolo.\par
\iflicenciaconfirmada\else
\faltante{Licencia a confirmar con la autora}\par
\fi
\vspace{0.9em}
ISBN \dato\datoISBN{en trámite, a cargo de Editorial Juana Manuela}\par
...
un ser enfermo más, tienen un eslabón más en la larga cadena de consumo.
...
\laminapagina{\carpetaimg/02-frontispicio.jpg}{%
...
\parteconlamina{La botica a un kilómetro a la redonda}
  ...
  {\carpetaimg/03-parte1-apertura.jpg}{%
...
\lamina[0.85\textwidth]{\carpetaimg/04-botica-kilometro.jpg}{%
...
\lamina{\carpetaimg/05-cosecha-secado.jpg}{%
...
\lamina{\carpetaimg/06-preparaciones-infusion.jpg}{%
...
\lamina{\carpetaimg/07-tintura-madre.jpg}{%
...
\parteconlamina{Las plantas de la quebrada}
  ...
  {\carpetaimg/08-parte2-apertura.jpg}{%
...
\laminadiferida{\carpetaimg/09-algarrobo.jpg}{%
...
dulce que resulta de la cocción del fruto, se toma también para la garganta.
\end{planta}

\laminadiferida{\carpetaimg/10-chanar.jpg}{%
...
los chicos. No se usa en el embarazo, y no reemplaza la consulta
por el peso.
\end{cuidado}
\end{planta}

\laminadiferida{\carpetaimg/11-molle.jpg}{%
...
en decocción tiene fama de desinfectante fuerte, y las mujeres la usan
mucho en baños de asiento para tratar el flujo excesivo o anormal. La decocción
de las hojas se usó tradicionalmente contra la sífilis, y la infusión de
las mismas hojas se usa para los dolores musculares.
...
pequeñas y ovaladas de color verde grisáceo. Las ramas en cocimiento se
usan en baños para los dolores de huesos; la infusión se usó
...
las cenizas se aplican sobre los músculos para los dolores reumáticos y
las contracturas. A la infusión se la tiene por reconstituyente del hígado, y las hojas
...
\lamina[0.74\textwidth]{\carpetaimg/16-lamina-arboles-espinosos.jpg}{%
...
\lamina{\carpetaimg/20-monte-panoramica.jpg}{%
...
\laminadiferida{\carpetaimg/12-jarilla.jpg}{%
...
pringosas y de perfume dulce. Como es muy resinosa, dicen que levanta la
temperatura corporal y activa la circulación, y por eso se usa en
cataplasma para reumatismo, luxaciones y dolores musculares. En infusión se usa como
...
\lamina[0.82\textwidth]{\carpetaimg/17-lamina-resinosas.jpg}{%
...
hojas y flores en agua sacada del hervor se toma para los trastornos
digestivos y los empachos de agua, y para fortalecer el estómago —unos 30 a 40
...
sarpullidos y erupciones. Se usa también para el empacho y para los
trastornos nerviosos: una infusión al dormir se recomienda a
...
hoja con la mano y se coloca. En infusión se la tiene por sudorífica y
emenagoga, y se la usa como descongestivo en la tos, la faringitis y la laringitis;
se le atribuye calmar el dolor y cicatrizar la garganta de
manera casi inmediata. Quienes la usan así la toman tres o cuatro
días seguidos, tres veces por día.
\begin{cuidado}[No en el embarazo]
Como se la tiene por emenagoga, es decir, que estimula el flujo
menstrual, la salvia mora no se usa durante el embarazo.
\end{cuidado}
\end{planta}
...
\lamina[0.74\textwidth]{\carpetaimg/13-lamina-aromaticas.jpg}{%
  Cedrón, incayuyo y salvia mora: las tres aromáticas de la casa.}

\laminapagina{\carpetaimg/14-lamina-digestivas.jpg}{%
...
nervaduras marcadas y flores en espigas. Como cataplasma se usa para
...
se aplica sobre las heridas para detener el sangrado y ayudar a
cicatrizar, y se le atribuye prevenir infecciones. Una gotita del jugo de hojas
...
secundarias que nacen de los nudos; crece cerca de los arroyos. En el valle
se la tiene por cicatrizante y astringente, y con ella se limpian las
...
La infusión de las hojas se toma contra el empacho y los asentamientos. Se lo
...
\lamina[0.6\textwidth]{\carpetaimg/15-lamina-cicatrizantes.jpg}{%
  Llantén, cola de caballo y paico: la roseta, el tallo hueco y la
  espiga dentada.}

\begin{planta}{Liga}{Phoradendron liga}{Toda la planta}
\phantomsection\label{pl-liga}%
Planta hemiparásita: usa a los árboles como soporte para obtener agua y
nutrientes minerales, pero fotosintetiza sus propios carbohidratos. Forma
matas sobre las ramas de algarrobos, tuscas y chañares, con tallos
verdes y articulados, hojas opuestas, gruesas y ovaladas, flores
diminutas y bayas pequeñas, globosas y rosadas. Se la tiene por un fuerte
depurador de la sangre y se la usa como hipotensora, y la tradición le
atribuye efectos antitumorales. Se la emplea también cuando los hombres
tienen problemas para orinar y para las durezas en los pechos de las
mujeres.

Conviene saber que en el valle se llama liga a más de una planta
hemiparásita. La de esta ficha, la del cuadernillo, es
\textit{Phoradendron liga}. La que la literatura argentina llama
«muérdago criollo» es otra, \textit{Ligaria cuneifolia}, de flores
rojas y tubulares, y los estudios sobre la presión y los tumores que
suelen citarse se hicieron con ella, no con esta.
\begin{cuidado}[Tóxica: solo bajo supervisión, y sin promesas]
Como los demás muérdagos, cualquiera de las ligas es tóxica, sobre todo sus frutos:
...
% Altura máxima de 5 cm: con más, la lámina no entra en la página de la
% ficha y el capítulo 7 se corre dos páginas. Una lámina apaisada (2,6:1)
% ocupa así el ancho completo de la caja.
\lamina[\textwidth,height=5cm,keepaspectratio]{\carpetaimg/18-liga-muerdago.jpg}{%
  Liga (\textit{Phoradendron liga}): mata sobre su hospedante, hojas
  gruesas y bayas rosadas.}
...
\laminadiferida{\carpetaimg/19-lamina-toxicas.jpg}{%
...
\entradaplanta{Liga}{pl-liga}{\textit{Phoradendron liga}}
...
\begin{description}[leftmargin=0pt, style=nextline, font=\sffamily\bfseries\footnotesize\color{verdehuerta}, itemsep=0.1em, topsep=0pt]
  ...
  \item[Cardiotónico.] Al que se atribuye la capacidad de fortalecer el corazón.
...
\lamina{\carpetaimg/21-mate-cedron.jpg}{%
...
\noindent Este libro se terminó de componer en septiembre de 2026, a
partir del cuadernillo
...
Garde Gothic (URW Gothic) para los títulos.

\vspace{0.8em}
\noindent Se terminó de imprimir en
\dato\datoFechaImpresion{mes y año} en \dato\datoImprenta{imprenta,
ciudad}, sobre papel \dato\datoPapel{papel y gramaje del interior}, con
tapas en \dato\datoTapas{cartulina de tapas}. Tirada:
\dato\datoTirada{cantidad} ejemplares.
...
\laminapagina{\carpetaimg/22-cierre-canasto.jpg}{%
...
\thispagestyle{empty}
\AddToShipoutPictureBG*{%
  \put(0,0){\includegraphics[width=\paperwidth,height=\paperheight]{\carpetaimg/23-contratapa.jpg}}}
\begin{tikzpicture}[remember picture, overlay]
